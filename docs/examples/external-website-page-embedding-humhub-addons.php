...
<html>
    ...
    <body>
        ...
        <iframe id="humhub-addons" src="<?= rtrim($humhubUrl, '/') ?>/s/<?= $spaceUrl ?>/external-websites/page?<?= http_build_query($params) ?>" style="min-height: 700px;" onload="loadIFrameResize();"></iframe>
