...
* se connecter en ssh : `ssh web@hameaux-legers.org` (mettre le mot de passe)
  ...
  ```
  cd ~/communaute.hameaux-legers.org/protected/modules
  git clone https://github.com/cuzy-app/external-websites.git external-websites
  ```
...
Pour info, voici le payload associé à cette jwtKey afin que qu'un nouvel utilisateur soit automatiquement ajouté aux groupes d'ID 1 et 2 (cf [doc de l'extension external-website](https://github.com/cuzy-app/external-websites/tree/main/docs)) :
...
* modifier le fichier fiche-1201.tpl.html en exécutant `vi ~/mooc.hameaux-legers.org/tools/lms/templates/bazar/fiche-1201.tpl.html` :
    ...
    * modifier la valeur de la variable $humhubUrl et mettre : le TOKEN calculé à partir du payload et de API_SECRET_KEY en suivant la procédure décrite dans la [doc de l'extension external-website](https://github.com/cuzy-app/external-websites/tree/main/docs)
...
* [doc de l'extension external-website (HumHub)](https://github.com/cuzy-app/external-websites/tree/main/docs)
