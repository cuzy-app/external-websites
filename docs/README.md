...
```
wget https://github.com/cuzy-app/external-websites/tree/main/resources/js/iframeResizer/iframeResizer.contentWindow.min.js
wget https://github.com/cuzy-app/external-websites/tree/main/resources/js/iframeResizer/iframeResizer.contentWindow.js
wget https://github.com/cuzy-app/external-websites/tree/main/resources/js/iframeResizer/iframeResizer.contentWindow.map
wget https://github.com/cuzy-app/external-websites/tree/main/docs/examples/for-external-website-embedded-in-humhub.js
```
...
Upload these files on the external website server:
```
wget https://github.com/cuzy-app/external-websites/tree/main/resources/js/iframeResizer/iframeResizer.min.js
wget https://github.com/cuzy-app/external-websites/tree/main/resources/js/iframeResizer/iframeResizer.js
wget https://github.com/cuzy-app/external-websites/tree/main/resources/js/iframeResizer/iframeResizer.map
```

[See this code example for the external website to embed HumHub addons](https://github.com/cuzy-app/external-websites/tree/main/docs/examples/external-website-page-embedding-humhub-addons.php)
...
[See this code example for the external website to embed full HumHub](https://github.com/cuzy-app/external-websites/tree/main/docs/examples/external-website-page-embedding-full-humhub.php)
...
[See this code example](https://github.com/cuzy-app/external-websites/tree/main/docs/examples/external-website-page-embedding-full-humhub.php)
...
By adding params in the URL (`showComments`, `showLikes` and `showPermalink`). [See this code example](https://github.com/cuzy-app/external-websites/tree/main/docs/examples/external-website-page-embedding-humhub-addons.php)
