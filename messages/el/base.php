...
return array (
  ...
  'Icon' => 'Εικόνισμα',
  'If Humhub is embedded, prevent leaving the space' => 'Εάν το Humhub είναι ενσωματωμένο, αποτρέψτε την έξοδο από το χώρο',
  ...
  'Yes' => 'Ναί',
  'by Prevents clicking on links that will show an other page than the current space' => 'από Αποτρέπει το κλικ σε συνδέσμους που θα εμφανίζουν άλλη σελίδα εκτός από τον τρέχοντα χώρο',
