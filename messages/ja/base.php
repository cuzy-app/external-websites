...
return array (
  ...
  'External websites settings' => '外部Webサイトの設定',
  'Hide sidebar' => 'サイドバーを非表示',
  'Hide the space to all users except network and space administrators' => 'ネットワークとスペースの管理者を除くすべてのユーザーにスペースを非表示にする',
  ...
  'Title' => '題名',
  'URL of the external website to redirect all URLs of the space (if empty, no redirection)' => 'スペースのすべてのURLをリダイレクトする外部WebサイトのURL（空の場合、リダイレクトなし）',
  'Website ID' => 'ウェブサイトID',
