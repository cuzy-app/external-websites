...
return array (
  ...
  'Archive content when they are created' => 'コンテンツの作成時にアーカイブする',
  ...
  'Menu collapsed' => 'メニューが折りたたまれています',
  ...
  'The space\'s default one' => 'スペースのデフォルトのもの',
  'Title' => '題名',
  ...
  'Website owner (related content for comments will be created with this user)' => 'Web サイト所有者 (コメントの関連コンテンツはこのユーザーで作成されます)',
