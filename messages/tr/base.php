...
return array (
  ...
  'External websites settings' => 'Harici web sitesi ayarları',
  'Hide sidebar' => 'Kenar çubuğunu gizle',
  'Hide the space to all users except network and space administrators' => 'Alanı ağ ve alan yöneticileri dışında tüm kullanıcılara gizleyin',
  ...
  'Title' => 'Başlık',
  'URL of the external website to redirect all URLs of the space (if empty, no redirection)' => 'Alanın tüm URL\'lerini yeniden yönlendirmek için harici web sitesinin URL\'si (boşsa, yönlendirme yok)',
