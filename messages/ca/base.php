...
return array (
  ...
  'Enabled to ignore some params in the external website URL to link multiple URLs to a same content if only theses params are different.' => 'S\'ha activat per ignorar alguns paràmetres a l\'URL del lloc web extern per enllaçar diversos URL amb un mateix contingut si només aquests paràmetres són diferents.',
