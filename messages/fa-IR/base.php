...
return array (
  ...
  'External websites settings' => 'تنظیمات وب سایت های خارجی',
  'Hide sidebar' => 'پنهان کردن نوار کناری',
  'Hide the space to all users except network and space administrators' => 'فضا را برای همه کاربران به جز سرپرست شبکه و فضا پنهان کنید',
  ...
  'Title' => 'عنوان',
  'URL of the external website to redirect all URLs of the space (if empty, no redirection)' => 'URL وب سایت خارجی برای هدایت همه نشانی های اینترنتی فضا (در صورت خالی بودن ، بدون تغییر مسیر)',
