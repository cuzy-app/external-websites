...
return array (
  ...
  'Enabled to ignore some params in the external website URL to link multiple URLs to a same content if only theses params are different.' => 'فعال برای نادیده گرفتن برخی از پارامترها در URL وب سایت خارجی برای پیوند دادن چندین URL به یک محتوا در صورتی که فقط این پارامترها متفاوت باشند.',
