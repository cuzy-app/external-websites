...
return array (
  ...
  'Icon' => 'آیکون',
  'If Humhub is embedded, prevent leaving the space' => 'اگر Humhub تعبیه شده است ، از ترک فضا جلوگیری کنید',
  ...
  'Yes' => 'آره',
  'by Prevents clicking on links that will show an other page than the current space' => 'by مانع از کلیک روی پیوندهایی می شود که صفحه ای غیر از فضای فعلی را نشان می دهد',
