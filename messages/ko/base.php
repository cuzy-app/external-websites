...
return array (
  ...
  'External websites settings' => '외부 웹 사이트 설정',
  'Hide sidebar' => '사이드 바 숨기기',
  'Hide the space to all users except network and space administrators' => '네트워크 및 공간 관리자를 제외한 모든 사용자에게 공간 숨기기',
  ...
  'Title' => '표제',
  'URL of the external website to redirect all URLs of the space (if empty, no redirection)' => '공간의 모든 URL을 리디렉션 할 외부 웹 사이트의 URL (비어있는 경우 리디렉션 없음)',
  'Website ID' => '웹 사이트 ID',
