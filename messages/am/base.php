...
return array (
  ...
  'Allows to ignore some params in the external website URL to link multiple URLs to a same content if only theses params are different.' => 'ብዙ ዩአርኤሎችን ከተመሳሳይ ይዘት ጋር ለማገናኘት በውጫዊው ድር ጣቢያ ዩአርኤል ውስጥ ያሉ አንዳንድ ፓራሞችን ችላ ለማለት ያስችላል።',
  'Archive content when they are created' => 'ይዘት ሲፈጠሩ በማህደር ያስቀምጡ',
  ...
  'Menu collapsed' => 'ምናሌ ወድቋል',
  'Other website IDs' => 'ሌሎች የድር ጣቢያ መታወቂያዎች',
  'Owner' => 'ባለቤት',
  'Page' => 'ገጽ',
  'Page URL' => 'የገጽ ዩ.አር.ኤል.',
  'Page URL params to ignore' => 'ችላ የሚባሉ የገጽ URL መለኪያዎች',
  'Prevents clicking on links that will show an other page than the current space' => 'ከአሁኑ ቦታ ይልቅ ሌላ ገጽ የሚያሳዩ አገናኞችን ጠቅ ማድረግን ይከላከላል',
  'Private' => 'የግል',
  'Public' => 'ህዝባዊ',
  'Settings' => 'ቅንብሮች',
  ...
  'The space\'s default one' => 'የቦታው ነባሪ ነው።',
  'Title' => 'ርዕስ',
  ...
  'Website owner (related content for comments will be created with this user)' => 'የድር ጣቢያ ባለቤት (ለአስተያየቶች ተዛማጅ ይዘት ከዚህ ተጠቃሚ ጋር ይፈጠራል)',
  'Website updated' => 'ድርጣቢያ ተዘምኗል',
  'Websites management' => 'የድርጣቢያዎች አስተዳደር',
  'separated by commas' => 'በነጠላ ሰረዞች ተለያይተዋል።',
