...
return array (
  ...
  'Enabled to ignore some params in the external website URL to link multiple URLs to a same content if only theses params are different.' => '如果只有这些参数不同，则可以忽略外部网站 URL 中的某些参数以将多个 URL 链接到相同的内容。',
