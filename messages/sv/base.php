...
return array (
  ...
  'Icon' => 'Ikon',
  'If Humhub is embedded, prevent leaving the space' => 'Om Humhub är inbäddat, förhindra att lämna utrymmet',
  ...
  'Space ID' => 'Utrymme-ID',
  'Space settings' => 'Utrymmeinställningar',
  ...
  'Yes' => 'Ja',
  'by Prevents clicking on links that will show an other page than the current space' => 'genom Förhindrar att klicka på länkar som visar en annan sida än det aktuella utrymmet',
