...
return array (
  ...
  'Enabled to ignore some params in the external website URL to link multiple URLs to a same content if only theses params are different.' => 'Aktiverad för att ignorera vissa parametrar i den externa webbadressen för att länka flera webbadresser till samma innehåll om bara dessa parametrar är olika.',
