...
return array (
  ...
  'Enabled to ignore some params in the external website URL to link multiple URLs to a same content if only theses params are different.' => 'Cho phép bỏ qua một số tham số trong URL trang web bên ngoài để liên kết nhiều URL với cùng một nội dung nếu chỉ các tham số của chủ đề là khác nhau.',
