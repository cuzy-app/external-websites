...
return array (
  ...
  'Icon' => '图标',
  'If Humhub is embedded, prevent leaving the space' => '如果 Humhub 被嵌入，防止离开空间',
  ...
  'Yes' => '是',
  'by Prevents clicking on links that will show an other page than the current space' => '通过 防止单击将显示当前空间以外的其他页面的链接',
