...
return array (
  ...
  'Icon' => 'Икона',
  'If Humhub is embedded, prevent leaving the space' => 'Ако Humhub е вграден, предотвратете напускането на пространството',
  ...
  'Yes' => 'Да',
  'by Prevents clicking on links that will show an other page than the current space' => 'от Предотвратява щракването върху връзки, които ще показват страница, различна от текущото пространство',
